...
<body style="background-color:rgb(52, 73, 94, 38%)">
    ...
    <div class="signUpMsgCont">
        ...
        <br></br>
		<h3 style="text-align:center;">Enter Patient's TRN</h3>
        <form action="delete_patient_process.php" method= "post">
            <input type="number" name="trn" placeholder="TRN" class="credentials" style="margin-left:470px" required>
